      ...
      <div className="max-w-3xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-1">
            <Card className="h-full bg-gradient-to-br from-finance-light to-white border-finance-primary/20">
              <CardHeader>
                <CardTitle className="flex items-center text-finance-primary">
                  <MessageSquare className="mr-2" size={20} />
                  Get in Touch
                </CardTitle>
                <CardDescription>
                  We're here to help with your paycheck calculation questions
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="rounded-lg bg-white p-3 shadow-sm transition-all hover:shadow-md">
                  <h3 className="font-semibold text-finance-primary">Email</h3>
                  <p className="text-sm mt-1">support@salarycheck.me</p>
                </div>
                
                <div className="rounded-lg bg-white p-3 shadow-sm transition-all hover:shadow-md">
                  <h3 className="font-semibold text-finance-primary">Business Hours</h3>
                  <p className="text-sm mt-1">Monday-Friday: 9AM-5PM EST</p>
                </div>
                
                <div className="rounded-lg bg-white p-3 shadow-sm transition-all hover:shadow-md">
                  <h3 className="font-semibold text-finance-primary">Response Time</h3>
